...
typedef struct {
    ...
    uint8_t past_reflection[_PAST_SIZE_];
...
void sorts_set_tire(ports_t *sort, float diameter, float distance)
{
...
*/
int sorts_linetrase_for_average(ports_t *sort)
{
    int sum = 0;
    ...
    return (int)((float)sum / sort -> loading_len);
}
